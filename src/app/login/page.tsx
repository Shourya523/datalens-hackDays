...
import { Database, Eye, EyeOff, Lock, Sparkles, ArrowRight } from "lucide-react";
        ...
        <div className="relative bg-card/80 backdrop-blur-xl rounded-2xl border border-border/50 shadow-2xl overflow-hidden">
          ...
          <div className="relative p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground text-sm">Sign in to continue your data journey</p>
            </div>
                ...
                >
                  <div className="relative">
                    <Input
                      ...
                      onChange={handleChange}
                      required
                      className="h-11 bg-background/50 border-border/50 focus:border-primary/50 focus:ring-2 focus:ring-primary/20 transition-all pr-12"
                    />
                    <button
                      type="button"
